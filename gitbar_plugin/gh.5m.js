...
const root_path = '/Users/haroldduan/iWorkSpace/iGits/gitbar'
// Import User Setting
//require(root_path + '/node_modules/dotenv').config({path: __dirname + '/.env'});
require(root_path + '/node_modules/dotenv').config({path: root_path + '/.env'});
...
var gh = require(root_path + '/node_modules/gh-scrape'),
         visibleEmoji;
